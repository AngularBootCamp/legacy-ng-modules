# Angular Boot Camp example: legacy-ng-modules
...
**[StackBlitz for legacy-ng-modules](https://stackblitz.io/github/AngularBootCamp/legacy-ng-modules)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/legacy-ng-modules.git
cd legacy-ng-modules
npm install
npm start
```
